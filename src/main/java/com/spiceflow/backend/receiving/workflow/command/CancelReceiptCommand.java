...
public record CancelReceiptCommand(@Nullable String comment) implements WorkflowCommand<GoodsReceipt, GoodsReceiptState> {

    public CancelReceiptCommand() {
        this(null);
    }
    ...
    public GoodsReceiptState getTargetState() {
        return GoodsReceiptState.CANCELLED;
    }
