...
public record SubmitPurchaseOrderCommand(@Nullable String comment) implements WorkflowCommand<PurchaseOrder, PurchaseOrderState> {
    ...
    public PurchaseOrderState getTargetState() {
        return PurchaseOrderState.SUBMITTED;
    }
