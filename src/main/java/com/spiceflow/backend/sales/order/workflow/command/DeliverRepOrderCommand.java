...
public record DeliverRepOrderCommand(@Nullable String comment) implements WorkflowCommand<RepOrder, RepOrderState> {

    public DeliverRepOrderCommand() {
        this(null);
    }

    @Override
    public String getCommandName() {
        return "DeliverRepOrder";
    }

    @Override
    public RepOrderState getTargetState() {
        return RepOrderState.DELIVERED;
    }
